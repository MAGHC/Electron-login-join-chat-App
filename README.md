...
이런식으로 messages 객체가 구성되어있는 것을 참고할 수 있었다 다만 저게 아니여도 sendbird 썼던 때에 걸 그냥 봐도 됬지만 어찌됬건 내가 데이터 베이스를 처음부터 만들어야되는 상황이라서  사실 만들때는 그냥 아예 자르고 자르고 잘라서 보낸 메세지와 메세지 보낸 시점 정도만의 정보를 넣어주고 시작했다 
...
![image](https://user-images.githubusercontent.com/89845540/185726539-1e85a43b-e091-4013-b5a5-f09098f49cc0.png)
<br><br><br>
